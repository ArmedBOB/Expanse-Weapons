...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition ZeusClassRapidTorpedoLauncherPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ZeusClass_Rapid_Torpedo_Launcher", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Zeus Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MagsToLoad = 9, // Number of physical magazines to consume on reload.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Zeus Class Rapid Torpedo Launcher Audio", // Audio for firing.
        ...
        WeaponDefinition ZeusClassRapidTorpedoLauncherPartMES => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ZeusClass_Rapid_Torpedo_Launcher_MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up
