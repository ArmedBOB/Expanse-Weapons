...
{ // Don't edit above this line
    partial class Parts
    {
        private VRageMath.Vector3 TungstenTeflonPDCBox40mm_RGB = new VRageMath.Vector3(100, 100, 100);
        private AmmoDef TungstenTeflonPDCBox40mm => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "40mmTungstenTeflonPDCBoxMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "40mm Tungsten-Teflon Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 8533f, // Recoil. This is applied to the Parent Grid.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = (int)(2500 / 3000) * 60, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    {
                        Enable = true,
                        Length = (float)(1500 * 0.04), //
                        Width = (float)(0.04 + 0.02) * 6f, //
                        Color = new VRageMath.Vector4(14 * TungstenTeflonPDCBox40mm_RGB.X / TungstenTeflonPDCBox40mm_RGB.Max(),
                                                      14 * TungstenTeflonPDCBox40mm_RGB.Y / TungstenTeflonPDCBox40mm_RGB.Max(),
                                                      14 * TungstenTeflonPDCBox40mm_RGB.Z / TungstenTeflonPDCBox40mm_RGB.Max(),
