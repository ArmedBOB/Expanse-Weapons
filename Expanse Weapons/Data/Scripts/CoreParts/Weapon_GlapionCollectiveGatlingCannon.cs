...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition GlapionCollectiveGatlingCannonPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Glapion Collective Gatling Cannon", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "Barrel", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "Barrel", // The subpart where your muzzle empties are located. This is often the elevation subpart.
            ...
            {
                PartName = "Glapion Gatling Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Glapion Collective Gatling Cannon Audio", // Audio for firing.
