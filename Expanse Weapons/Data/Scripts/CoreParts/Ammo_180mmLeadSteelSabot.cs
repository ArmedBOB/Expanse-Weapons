...
{ // Don't edit above this line
    partial class Parts
    {
        VRageMath.Vector3 LeadSteelSabot180mm_RGB = new VRageMath.Vector3(255, 176, 0);
        private AmmoDef LeadSteelSabot180mm => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "180mmLeadSteelSabotMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "180mm Lead-Steel Sabot Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 21333f, // Recoil. This is applied to the Parent Grid.
            ...
            Shape = new ShapeDef // Defines the collision shape of the projectile, defaults to LineShape and uses the visual Line Length if set to 0.
            {
                ...
                Diameter = 0.18f * 4f, // Diameter is minimum length of LineShape or minimum diameter of SphereShape.
            },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = (int)(2000 / 2000) * 65, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    {
                        Enable = true,
                        Length = (float)(2000 * 0.18), //
                        Width = (float)(0.18 + 0.02) * 6f, //
                        Color = new VRageMath.Vector4(14 * LeadSteelSabot180mm_RGB.X / LeadSteelSabot180mm_RGB.Max(),
                                                      14 * LeadSteelSabot180mm_RGB.Y / LeadSteelSabot180mm_RGB.Max(),
                                                      14 * LeadSteelSabot180mm_RGB.Z / LeadSteelSabot180mm_RGB.Max(),
