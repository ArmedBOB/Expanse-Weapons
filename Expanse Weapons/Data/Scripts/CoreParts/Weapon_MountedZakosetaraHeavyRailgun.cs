...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition MountedZakosetaraHeavyRailgunPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Mounted Zakosetara Heavy Railgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Mounted Zakosetara Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Mounted Zakosetara Heavy Railgun Audio", // Audio for firing.
