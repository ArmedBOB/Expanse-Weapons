...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition VoltaireCollectiveAntiPersonnelPDCPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Voltaire Collective Anti Personnel PDC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Voltaire PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 2570, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Voltaire Collective Anti Personnel PDC Audio", // Audio for firing.
