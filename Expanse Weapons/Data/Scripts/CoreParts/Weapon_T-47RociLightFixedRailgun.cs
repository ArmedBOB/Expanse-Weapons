...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition T47RociLightFixedRailgunPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "T-47 Roci Light Fixed Railgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "T-47 Light Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "T-47 Roci Light Fixed Railgun Audio", // Audio for firing.
            ...
            Ammos = new[] {
                TungstenUraniumSabot80mm, // Must list all primary, shrapnel, and pattern ammos.
            },
