...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition OstmanJazinskiFlakCannonPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Ostman-Jazinski Flak Cannon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Scope = "dummy_scope", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                TopBlocks = 100, // Maximum number of blocks to randomize between; 0 = unlimited.
                StopTrackingSpeed = 0, // Do not track threats traveling faster than this speed; 0 = unlimited.
            },
            HardPoint = new HardPointDef
            {
                PartName = "Ostman-Jazinski PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.36f, // Projectile inaccuracy in degrees.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.08333334f, // Inventory capacity in kL.
                    IdlePower = 0.75f, // Constant base power draw in MW.
                ...
                Other = new OtherDef
                {
                    ...
                    RestrictionRadius = 4.75, // Prevents other blocks of this type from being placed within this distance of the centre of the block.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Ostman-Jazinski Flak Cannon Audio", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AutomaticSmokeExample", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                LeadSteelPDCBox40mm, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition OstmanJazinskiFlakCannonMESPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Ostman-Jazinski Flak Cannon MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MissileTurretBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MissileTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MissileTurretBarrels",// Your Elevating Subpart, that bit that moves up
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Ostman-Jazinski PDC MES", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.36f, // Projectile inaccuracy in degrees.
                AimingTolerance = 1f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
