...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition NarimanDynamicsPDCPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Nariman Dynamics PDC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Nariman PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 23850, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Nariman Dynamics PDC Audio", // Audio for firing.
        ...
        WeaponDefinition NarimanDynamicsPDCPartMES => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Nariman Dynamics PDC MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "GatlingBarrel", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "GatlingTurretBase2", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "GatlingTurretBase2",// Your Elevating Subpart, that bit that moves up
