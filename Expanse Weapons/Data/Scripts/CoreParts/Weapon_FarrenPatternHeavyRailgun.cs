...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition FarrenPatternHeavyRailgunPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Farren-Pattern Heavy Railgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Farren Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Farren-Pattern Heavy Railgun Audio", // Audio for firing.
            ...
            Ammos = new[] {
                TungstenUraniumSlug120mmUNN, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = RailgunAnimation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition FarrenPatternHeavyRailgunPartMES => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Farren-Pattern Heavy Railgun MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MissileTurretBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MissileTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MissileTurretBarrels",// Your Elevating Subpart, that bit that moves up
