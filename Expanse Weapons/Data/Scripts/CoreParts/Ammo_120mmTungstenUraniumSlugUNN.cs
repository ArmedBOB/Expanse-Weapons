...
{ // Don't edit above this line
    partial class Parts
    {
        VRageMath.Vector3 TungstenUraniumSlug120mmUNN_RGB = new VRageMath.Vector3(175, 0, 100);
        private AmmoDef TungstenUraniumSlug120mmUNN => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "120mmTungstenUraniumSlugUNNMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "120mm Tungsten-Uranium Slug UNN Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BaseDamage = 750000f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 33333333f, // Recoil. This is applied to the Parent Grid.
