...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition KessHashari180mmCannonPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Kess Hashari Cannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Kass Hashari Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Kess Hashari Cannon Audio", // Audio for firing.
            ...
            Ammos = new[] {
                LeadSteelSabot180mm, // Must list all primary, shrapnel, and pattern ammos.
            },
