...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition ApolloClassTorpedoLauncherPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Apollo Class Torpedo Launcher", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Apollo Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.8f, // Inventory capacity in kL.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Apollo Class Torpedo Launcher Audio", // Audio for firing.
            ...
            Ammos = new[] {
                ...
                LaunchStageRamshackleTorpedo,
                SecondStageRamshackleTorpedo,
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition ApolloClassTorpedoLauncherMESPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Apollo Class Torpedo Launcher MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Apollo Launcher MES", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 180, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Advanced, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
                ...
                Other = new OtherDef
                {
                    ...
                    MuzzleCheck = false, // Whether the weapon should check LOS from each individual muzzle in addition to the scope.
                    Debug = false, // Force enables debug mode.
                    RestrictionRadius = (5 - 0.25), // Prevents other blocks of this type from being placed within this distance of the centre of the block.
                    CheckInflatedBox = true, // If true, the above distance check is performed from the edge of the block instead of the centre.
                    CheckForAnyWeapon = true, // If true, the check will fail if ANY weapon is present, not just weapons of the same subtype.
                },
                Loading = new LoadingDef
