...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition ZakosetaraHeavyRailgunPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Zakosetara Heavy Railgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Zakosetara Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.03333333f, // Inventory capacity in kL.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Zakosetara Heavy Railgun Audio", // Audio for firing.
            ...
            Ammos = new[] {
                LeadSteelSlug120mm, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = RailgunAnimation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition ZakosetaraHeavyRailgunMESPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Zakosetara Heavy Railgun MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up
