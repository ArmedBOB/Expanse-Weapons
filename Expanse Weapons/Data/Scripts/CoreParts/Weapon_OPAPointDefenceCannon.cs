...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition OPAPointDefenceCannonPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Outer Planets Alliance Point Defence Cannon", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Scope = "scope_1", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "OPA PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.23f, // Projectile inaccuracy in degrees.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Outer Planets Alliance Point Defence Cannon Audio", // Audio for firing.
