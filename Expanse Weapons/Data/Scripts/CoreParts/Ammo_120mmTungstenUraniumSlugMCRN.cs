...
{ // Don't edit above this line
    partial class Parts
    {
        VRageMath.Vector3 TungstenUraniumSlug120mmMCRN_RGB = new VRageMath.Vector3(175, 0, 100);
        private AmmoDef TungstenUraniumSlug120mmMCRN => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "120mmTungstenUraniumSlugMCRNMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "120mm Tungsten-Uranium Slug MCRN Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.0003f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 900000f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 48000000f, // Recoil. This is applied to the Parent Grid.
            ...
            Shape = new ShapeDef // Defines the collision shape of the projectile, defaults to LineShape and uses the visual Line Length if set to 0.
            {
                ...
                Diameter = 0.12f * 4f, // Diameter is minimum length of LineShape or minimum diameter of SphereShape.
            },
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Modifier = 3.75f, // Multiplier for damage against shields.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = (int)(25000 / 15000) * 60, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 12500f, // voxel phasing if you go above 5100
                MaxTrajectory = 18000f, // Max Distance the projectile or beam can Travel.
