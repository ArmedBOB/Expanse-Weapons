...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef LaunchStage220mmExplosiveTorpedo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "220mmExplosiveTorpedoMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "220mm Explosive Torpedo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Shape = new ShapeDef // Defines the collision shape of the projectile, defaults to LineShape and uses the visual Line Length if set to 0.
            {
                ...
                Diameter = 0.22 * 2f, // Diameter is minimum length of LineShape or minimum diameter of SphereShape.
            },
            ...
            {
                AmmoRound = "220mm Explosive Torpedo Real", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 16000f, // Max Distance the projectile or beam can Travel.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    TrackingDelay = 110, // Measured in Shape diameter units traveled.
            ...
            {
                ModelName = "\\Models\\Synirr\\Ammo\\220mm Explosive Torpedo\\220mm_Explosive_Torpedo.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f, //
                        Width = 0.5f, //
                        Color = Color(red: 0f, green: 0f, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 0f, green: 0f, blue: 10f, alpha: 1),
                        Back = true,
                        CustomWidth = 1f,
        ...
        private AmmoDef SecondStageExplosiveTorpedo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "220mmExplosiveTorpedoMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "220mm Explosive Torpedo Real", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            Health = 6f, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0f, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = (int)(25000/1500)*60, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                ...
                MaxTrajectory = 22500f, // Max Distance the projectile or beam can Travel.
                FieldTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
                ...
                {
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 5.5f, // controls how responsive tracking is.
                    MaxLateralThrust = 0.25, // controls how sharp the trajectile may turn
                    TrackingDelay = 0, // Measured in Shape diameter units traveled.
                    MaxChaseTime = (int)(25000 / 1500) * 60, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
                    MaxTargets = 0, // Number of targets allowed before ending, 0 = unlimited
                    NoTargetExpire = false, // Expire without ever having a target at TargetLossTime
                    Roam = false, // Roam current area after target loss
