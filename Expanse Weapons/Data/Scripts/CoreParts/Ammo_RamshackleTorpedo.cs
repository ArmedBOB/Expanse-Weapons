...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef LaunchStageRamshackleTorpedo=> new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "RamshackleTorpedoMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Ramshackle Torpedo Magazine", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Ramshackle Torpedo Magazine Real", // AmmoRound field of the ammo to spawn.
            ...
            {
                ModelName = "\\Models\\Synirr\\Ammo\\Ramshackle Torpedo\\Ramshackle Torpedo.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
        ...
        private AmmoDef SecondStageRamshackleTorpedo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "RamshackleTorpedoMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Ramshackle Torpedo Magazine Real", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = (int)(25000 / 1000) * 60, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                ...
                {
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 3.5f, // controls how responsive tracking is.
                    MaxLateralThrust = 0.15, // controls how sharp the trajectile may turn
                    TrackingDelay = 0, // Measured in Shape diameter units traveled.
                    MaxChaseTime = (int)(25000 / 1000) * 60, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
                    MaxTargets = 0, // Number of targets allowed before ending, 0 = unlimited
                    NoTargetExpire = false, // Expire without ever having a target at TargetLossTime
                    Roam = false, // Roam current area after target loss
