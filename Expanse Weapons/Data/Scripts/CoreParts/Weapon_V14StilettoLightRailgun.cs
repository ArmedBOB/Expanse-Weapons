...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition V14StilettoLightRailgunPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "V-14 Stiletto Light Railgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Stiletto Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 100000, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "V-14 Stiletto Light Railgun Audio", // Audio for firing.
            ...
            Ammos = new[] {
                TungstenUraniumSlug100mmMCRN, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = RailgunAnimation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition V14StilettoLightRailgunPartMES => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "V-14 Stiletto Light Railgun MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MissileTurretBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MissileTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MissileTurretBarrels",// Your Elevating Subpart, that bit that moves up
