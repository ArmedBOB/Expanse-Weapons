...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition DawsonPatternMediumRailgunPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Dawson-Pattern Medium Railgun", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Dawson Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.08333333f, // Inventory capacity in kL.
                    IdlePower = 1.5f, // Constant base power draw in MW.
                ...
                {
                    RateOfFire = 80000, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Dawson-Pattern Medium Railgun Audio", // Audio for firing.
            ...
            Ammos = new[] {
                TungstenUraniumSlug100mmUNN, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = RailgunAnimation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition DawsonPatternMediumRailgunPartMES => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Dawson-Pattern Medium Railgun MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "MissileTurretBarrels", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "MissileTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "MissileTurretBarrels",// Your Elevating Subpart, that bit that moves up
