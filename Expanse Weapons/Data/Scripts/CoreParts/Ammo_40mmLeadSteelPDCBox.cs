...
{ // Don't edit above this line
    partial class Parts
    {
        VRageMath.Vector3 LeadSteelPDCBox40mm_RGB = new VRageMath.Vector3(255, 176, 0);
        private AmmoDef LeadSteelPDCBox40mm => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "40mmLeadSteelPDCBoxMagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "40mm Lead-Steel PDC Box Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 4266f, // Recoil. This is applied to the Parent Grid.
            ...
            Shape = new ShapeDef // Defines the collision shape of the projectile, defaults to LineShape and uses the visual Line Length if set to 0.
            {
                ...
                Diameter = 0.04f * 4f, // Diameter is minimum length of LineShape or minimum diameter of SphereShape.
            },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = (int)(2500 / 2500) * 60, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 2500f, // voxel phasing if you go above 5100
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    {
                        Enable = true,
                        Length = (float)(1250 * 0.04), //
                        Width = (float)(0.04 + 0.02) * 6f, //
                        Color = new VRageMath.Vector4(14 * LeadSteelPDCBox40mm_RGB.X / LeadSteelPDCBox40mm_RGB.Max(),
                                                      14 * LeadSteelPDCBox40mm_RGB.Y / LeadSteelPDCBox40mm_RGB.Max(),
                                                      14 * LeadSteelPDCBox40mm_RGB.Z / LeadSteelPDCBox40mm_RGB.Max(),
                                                      1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
