...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition RedfieldBallisticsPDCPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Redfields Ballistics PDC", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Redfields PDC", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MaxHeat = 41490, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Redfields Ballistics PDC Audio", // Audio for firing.
            ...
            Ammos = new[] {
                TungstenTeflonPDCBox40mm, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition RedfieldBallisticsPDCPartMES => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Redfields Ballistics PDC MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "GatlingTurretBase2", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "GatlingTurretBase1", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "GatlingTurretBase2",// Your Elevating Subpart, that bit that moves up
