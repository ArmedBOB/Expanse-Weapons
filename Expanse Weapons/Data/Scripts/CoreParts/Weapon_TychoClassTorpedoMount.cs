...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition TychoClassTorpedoMountPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Tycho Class Torpedo Mount", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Tycho Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Tycho Class Torpedo Mount Audio", // Audio for firing.
            ...
            Ammos = new[] {
                ...
                SecondStageRamshackleTorpedo, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };

        WeaponDefinition TychoClassTorpedoMountMESPart => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Tycho Class Torpedo Mount MES", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up
